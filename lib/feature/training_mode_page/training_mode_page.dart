                  ...
                  TrainingModeCard(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const StrenghtInformationPage(),
                        ),
                      );
                    },
                  ),
                  ...
                  TrainingModeCard(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const ResistenceInformationPage(),
                          ),
                        );
                      }),
                  const SizedBox(
                  ...
                  TrainingModeCard(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const HipertrofyInformationPage(),
                          ),
                        );
                      }),
                  const SizedBox(
                  ...
                  TrainingModeCard(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const CardioInformationPage(),
                          ),
                        );
                      },
                      ),
