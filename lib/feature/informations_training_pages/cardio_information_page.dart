...
class CardioInformationPage extends StatefulWidget {
  ...
  @override
  State<CardioInformationPage> createState() =>
      _CardioInformationPageState();
}
                    ...
                    Column(
                      ...
                      children: [
                          ...
                          RichText(
                            text: TextSpan(text: "de",
                                style: FontApp.mainfont22.copyWith(
                                  color: ColorsApp.maincolor4,),
                                children: <TextSpan>[
                                  TextSpan(text: "queima de gordura", style: FontApp.mainfont30.copyWith(color: ColorsApp.maincolor3, fontWeight: FontWeight.bold)),
                                ]),
                          ),
                        Text("e no desenvolvimento",
                          ...
                          RichText(
                            text: TextSpan(text: "da",
                                style: FontApp.mainfont22.copyWith(
                                  color: ColorsApp.maincolor4,),
                                children: <TextSpan>[
                                  TextSpan(text: "capacidade", style: FontApp.mainfont30.copyWith(color: ColorsApp.maincolor3, fontWeight: FontWeight.bold)),
                                ]),
                          ),
                        Text("cardíaca",
                            textAlign: TextAlign.start,
                          ...
                          RichText(
                            text: TextSpan(text: "e",
                                style: FontApp.mainfont22.copyWith(
                                  color: ColorsApp.maincolor4,),
                                children: <TextSpan>[
                                  TextSpan(text: "pulmonar.", style: FontApp.mainfont30.copyWith(color: ColorsApp.maincolor3, fontWeight: FontWeight.bold)),
                                ]),
                          ),
                      ],
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text("variar entre",
                          ...
                          RichText(
                            text: TextSpan(text: "tempo",
                                style: FontApp.mainfont30.copyWith(
                                  color: ColorsApp.maincolor3, fontWeight: FontWeight.bold),
                                children: <TextSpan>[
                                  TextSpan(text: ",", style: FontApp.mainfont30.copyWith(color: ColorsApp.maincolor4)),
                                  TextSpan(text: "intensidade", style: FontApp.mainfont30.copyWith(color: ColorsApp.maincolor3, fontWeight: FontWeight.bold))
                                ]),
                          ),
                        Text("calorias",
                            textAlign: TextAlign.start,
