...
class ExercisesCard2 extends StatelessWidget {
  ...
  const ExercisesCard2({ Key? key, required this.muscularGroup, required this.muscularPhotoGroup }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Center(
      child: ExpansionTileCard(
        title: Text("") ,
        leading: Text (muscularGroup, style: FontApp.mainfont30.copyWith(color: ColorsApp.maincolor4,), textAlign: TextAlign.center,),
